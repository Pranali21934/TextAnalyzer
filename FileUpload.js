...
function FileUpload() {
  ...
  return (
    <div >
    {/* <Search top5Words={analysisResults.top5Words} top5CoOccurrences={analysisResults.top5CoOccurrences}></Search> */}
